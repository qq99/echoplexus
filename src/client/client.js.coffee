((root, factory) ->
  ...
  if typeof exports isnt "undefined"
    ...
    # AMD
    define ["underscore", "backbone", "PermissionModel", "regex", "CryptoWrapper", "exports"], (_, Backbone, PermissionModel, Regex, crypto, exports) ->

      # Export global even in AMD case in case this script is loaded with
      # others that may still expect a global Backbone.
      factory exports, Backbone, _, PermissionModel.PermissionModel, Regex.REGEXES, crypto

) this, (exports, Backbone, _, PermissionModel, REGEXES, crypto, config) ->
  ...
  exports.ClientsCollection = Backbone.Collection.extend(model: exports.ClientModel)
