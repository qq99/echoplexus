define ["jquery", "underscore", "backbone", "client", "regex", "ui/Faviconizer", "CryptoWrapper", "modules/chat/Autocomplete", "modules/chat/Scrollback", "modules/chat/Log", "modules/chat/ChatLog", "ui/Mewl", "text!modules/chat/templates/chatPanel.html", "text!modules/chat/templates/chatInput.html", "text!modules/chat/templates/channelCryptokeyModal.html", "text!modules/chat/templates/fileUpload.html"], ($, _, Backbone, Client, Regex, faviconizer, crypto, Autocomplete, Scrollback, Log, ChatLog, Mewl, chatpanelTemplate, chatinputTemplate, cryptoModalTemplate, fileUploadTemplate) ->
  ...
  Backbone.View.extend
    ...
    chatMessage: Backbone.Model.extend(getBody: (cryptoKey) ->
      body = @get("body")
