define ["jquery", "backbone", "underscore", "regex", "moment", "CryptoWrapper", "text!modules/chat/templates/chatArea.html", "text!modules/chat/templates/chatMessage.html", "text!modules/chat/templates/linkedImage.html", "text!modules/chat/templates/userListUser.html", "text!modules/chat/templates/youtube.html", "text!modules/chat/templates/webshotBadge.html"], ($, Backbone, _, Regex, moment, crypto, chatareaTemplate, chatMessageTemplate, linkedImageTemplate, userListUserTemplate, youtubeTemplate, webshotBadge) ->
