...
Loader                    = require('../../client/loader.js.coffee').Loader
channelSelectorTemplate   = require('../../client/templates/channelSelector.html')

# Clients:
# abstract this to config.coffee
ChatClient                = require('../../client/modules/chat/client.js.coffee').ChatClient
InfoClient                = require('../../client/modules/info/client.js.coffee').InfoClient
